...
echo "   docker run -p 8800:8800 --network bridge --name drivewise-app ${REGISTRY_PREFIX}${IMAGE_NAME}:latest-amd64"
echo ""
...
echo "   3. On Raspberry Pi: docker run -p 8800:8800 --network bridge --name drivewise-app ${REGISTRY_PREFIX}${IMAGE_NAME}:latest-arm64"
echo ""
